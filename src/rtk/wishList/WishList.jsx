        ...
        <div className="wishlist mt-5 mb-5">
            <div className="container">
                <div className="d-flex justify-content-between align-items-center mt-5 mb-5">
                    ...
                    <span className={wishlist.length > 0 ? "clear ps-4 pe-4 pt-2 pb-2 fw-bold btn mt-3 d-flex align-items-center justify-content-center"
                        : "d-none"}
                ...
                <div className={wishlist.length > 0 ? "mt-5" : "d-none"}>
                    <Header title="Just For You" />
                    <div className="d-flex justify-content-end mb-5">
                        <span className="clear ps-4 pe-4 pt-2 pb-2 fw-bold btn d-flex align-items-center justify-content-center"
